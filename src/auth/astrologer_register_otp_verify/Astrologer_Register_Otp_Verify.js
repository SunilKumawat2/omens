...
const Astrologer_Register_Otp_Verify = () => {
                ...
                <div className="gi-login-wrapper my-[0] mx-auto">
                  <div className="gi-login-container">
                    <div className="gi-login-form">
                      <form action="#" method="post" className="flex flex-col" onSubmit={Handle_User_Regsiter_Otp_Verify}>
...
export default Astrologer_Register_Otp_Verify;
