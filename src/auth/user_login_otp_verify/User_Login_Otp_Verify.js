...
const User_Login_Otp_Verify = () => {
    ...
    const Handle_User_Login_Otp_Verify = async (e) => {
        ...
        if (otp.length !== 4) {
            setOtpError(true); // Show the error below the OTP input field
            setIsLoading(false);
        ...
        try {
            ...
            const otp_verify_data = {
                ...
                mobile,
                device_type: "web",
                fcm_token,  // Use the retrieved FCM token here
            };
...
export default User_Login_Otp_Verify