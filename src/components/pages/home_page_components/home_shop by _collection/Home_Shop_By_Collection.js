...
const Home_Shop_By_Collection = (home_data) => {
       const navigate = useNavigate();
    const shop_by_collection = home_data?.data?.shop_by_collection
    console.log("shop_by_collection", shop_by_collection)
    return (
        <div>
                        ...
                        <div className="gi-deal-section w-full">
                            <div className="gi-products">
                                ...
                                <div className="gi-deal-block mx-[-12px]" data-aos="fade-up" data-aos-duration="2000"
                                    data-aos-delay="300">
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 cursor-pointer gap-2">
                                        {
                                            shop_by_collection?.map((product_list_result) => {
                                                return (
                                                    <>
                                                        <div onClick={() =>
                                                        ...
                                                        } className="gi-products bg-no-repeat text-center bg-cover h-[400px] md:h-[600px] overflow-hidden relative"
                                                            style={{
                                                                backgroundImage: `url(${IMG_BASE_URL}${product_list_result?.single_image?.image_url})`,
                                                            }}>
