                                            ...
                                            <div className="gi-sidebar-wrap p-[15px] rounded-[5px] shadow-lg">
                                                ...
                                                <div className="gi-sidebar-block mb-4">
                                                    <div className="gi-sb-title border-b border-gray-200 pb-4">
                                                        ...
                                                        <h3 className="gi-sidebar-title font-semibold text-gray-700 flex justify-between text-[17px] leading-tight" onClick={toggle_origin_accordion}>Origin  ▼ </h3>
                                                    </div>
                                                    {/* Accordion Content */}
                                                    {is_Open_Origin && (
                                                ...
                                                <div className="gi-sidebar-block mb-[15px]">
                                                    <div className="gi-sb-title border-b-[1px] border-solid border-[#eee] pb-[15px]">
                                                        ...
                                                        <h3 className="gi-sidebar-title font-semibold tracking-[0] relative text-[#4b5966] w-full
                                                                 flex justify-between font-Poppins text-[17px] leading-[1.2]" onClick={toggle_Shape_accordion}>Shape  ▼</h3>
                                                    </div>
                                                    {is_Open_Shape && (
                                                ...
                                                <div className="gi-sidebar-block mb-[15px]">
                                                    <div className="gi-sb-title border-b-[1px] border-solid border-[#eee] pb-[15px]">
                                                        ...
                                                        <h3 className="gi-sidebar-title font-semibold tracking-[0] relative text-[#4b5966] w-full
                                                                 flex justify-between font-Poppins text-[17px] leading-[1.2]" onClick={toggle_color_accordion}>Color  ▼</h3>
                                                    </div>
                                                    {is_Open_Color && (
                                                        <div className="gi-sb-block-content mt-[15px]">
                                                            <ul>
                                                ...
                                                <div className="gi-sidebar-block mb-[15px] color-block gi-sidebar-block-clr">
                                                    <div className="gi-sb-title border-b-[1px] border-solid border-[#eee] pb-[15px]">
                                                        ...
                                                        <h3 className="gi-sidebar-title font-semibold tracking-[0] relative text-[#4b5966] w-full
                                                                 flex justify-between font-Poppins text-[17px] leading-[1.2]" onClick={toggle_treatment_accordion}>Treatment  ▼</h3>
                                                    </div>
                                                    {is_Open_treatment && (
                                                        <div className="gi-sb-block-content mt-[15px]">
                                                            <ul>
