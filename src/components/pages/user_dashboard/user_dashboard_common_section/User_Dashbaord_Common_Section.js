                    ...
                    <div className="flex flex-col space-y-8">
                        ...
                        <div className="item group"><Link to="/user-wallet">
                            <div
                                ...
                                </svg></span><span className=" font-normal text-base">Wallet</span>
                            </div>
                        </Link></div>
                        ...
                        <div className="item group"><Link to="/user-address">
                            <div
                                ...
                                </svg></span><span className=" font-normal text-base">Address</span>
                            </div>
                        </Link></div>
                        ...
                        <div className="item group"><Link to="/user-my-pooja-list">
                            <div
                                ...
                                </svg></span><span className=" font-normal text-base">My Book Pooja</span>
                            </div>
                        </Link></div>
                        <div className="item group">
                            <Link to="/follow-list">
                                <div className="flex space-x-3 items-center text-gray-400 hover:text-gray-900 transition-colors duration-300">
                                    ...
                                    {/* Text */}
                                    <span className="font-normal text-base">Follow List</span>
                                </div>
                            </Link>
                        </div>
                        ...
                        <div className="item group"><Link to="/user-logout">
                            <div
                                ...
                                </svg></span><span className=" font-normal text-base">Logoout</span>
                            </div>
                        </Link></div>
                    </div>
                )
...
export default User_Dashbaord_Common_Section