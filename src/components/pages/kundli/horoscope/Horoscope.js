    ...
    return (
        <>
            <div className="gi-product-content">
                <div
                    className="gi-product-inner transition-all duration-[0.3s] ease-in-out cursor-pointer overflow-hidden rounded-[5px] bg-white pt-4">
                    <div
            ...
            <div className="gi-product-contentmy-5">
                <div
