...
const Astrologer_Home_Chat_History = () => {
  return (
                ...
                <div className="border rounded-lg p-4 bg-white">
                    <div className="flex justify-between">
                        <div>
                            ...
                            <p className="text-[#EDA801] text-sm">Loyal User offer(25%)</p>
                        </div>
                    ...
                    <div className="shadow rounded-md p-4 mt-3">
                        ...
                        <div>
                            <span
                                className="mb-2 whitespace-nowrap inline-block text-gray-900 hover:text-white border hover:bg-gray-900 rounded-full text-sm px-5 py-2 text-center mt-2">Assistant
                                Chat</span>
                            <span
                                className="mb-2 whitespace-nowrap inline-block text-gray-900 hover:text-white border hover:bg-gray-900 rounded-full text-sm px-5 py-2 text-center mt-2">Suggest
                                Remedy</span>
                            <span
...
export default Astrologer_Home_Chat_History