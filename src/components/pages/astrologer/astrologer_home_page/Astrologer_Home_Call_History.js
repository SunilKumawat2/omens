...
const Astrologer_Home_Call_History = () => {
                        ...
                        <div
                            ...
                            <div className="gi-tab-title w-full inline-flex justify-between px-[12px] max-[991px]:flex-col items-center">
                                ...
                                <div className="gi-pro-tab max-[991px]:mt-[-20px] max-[991px]:mb-[30px]">
                                    <Link to="/astrologer-all-call-history-list"
                            ...
                            <div className="w-full mb-[-24px]">
                                <div
                                    ...
                                    {
                                        get_astrologer_call_history_list?.slice(0, 3)?.map((get_astrologer_call_history_list_result) => {
                                            return (
                                                <>
...
export default Astrologer_Home_Call_History