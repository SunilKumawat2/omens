                                        ...
                                        <div className="nav-desk">
                                            <div className="w-full flex flex-wrap px-[12px] min-[1400px]:relative">
                                                <div className="basis-auto w-full self-center">
                                                    <div className="gi-main-menu flex">
                                                        <ul className="w-full flex justify-center flex-wrap pl-[0]">
                                                            <li className="all_menus dropdown drop-list relative ml-[20px] mr-[18px] transition-all duration-[0.3s] ease-in-out max-[1199px]:ml-[15px]">
                                                                <Link to="#" className="dropdown-arrow relative transition-all duration-[0.3s] ease-in-out md:text-[12px] xl:text-[14px] leading-[60px] capitalize text-[#4b5966] flex items-center font-medium">Zodiac Stones (Rashi Ratna)</Link>
                                                                <ul className="sub-menu transition-all duration-[0.3s] ease-in-out mt-[15px] absolute z-[16] text-left opacity-0 invisible min-w-[205px] left-0 right-auto bg-[#fff] block rounded-[5px] border-[1px] border-solid border-[#eee] py-[5px]">
                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span>
                                                                                <img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Hessonite_3.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>
                                                                    ...
                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span>
                                                                                <img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Pearl.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>
                                                                            Pearl (Moti)								</a>
                                                                    </li>
                                                                    ...
                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span>
                                                                                <img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Ruby.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>
                                                                            Ruby (Manik)								</a>
                                                                    </li>
                                                                    ...
                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span>
                                                                                <img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Red_Coral.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>
                                                                            Red Coral (Moonga)								</a>
                                                                    </li>
                                                                    ...
                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span>
                                                                                <img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/white-sapphire.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>
                                                                            White Sapphire								</a>
                                                                    </li>
                                                                    ...
                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span>
                                                                                <img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/yellow-sapphire_4.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>
                                                            ...
                                                            <li className="all_menus dropdown drop-list relative ml-[20px] mr-[18px] transition-all duration-[0.3s] ease-in-out max-[1199px]:ml-[15px]">
                                                                <Link to="#" className="dropdown-arrow relative transition-all duration-[0.3s] ease-in-out md:text-[12px] xl:text-[14px] leading-[60px] capitalize text-[#4b5966] flex items-center font-medium">Popular Vedic Gems</Link>
                                                                <ul className="sub-menu transition-all duration-[0.3s] ease-in-out mt-[15px] absolute z-[16] text-left opacity-0 invisible min-w-[205px] left-0 right-auto bg-[#fff] block rounded-[5px] border-[1px] border-solid border-[#eee] py-[5px]">

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Amethyst_4.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Amethyst                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/citrine.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Citrine (Sunela)                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Fire_opal_1.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Fire Opal                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Garnet_4.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Garnet                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/iolite_4.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Iolite (Neeli)                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/navaratna_1.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Navratna                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/opal.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Opal                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Peridot_3.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Peridot                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/Pitambari-Neelam_3.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Pitambari Neelam                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/turquoise.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Turquoise                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/White-Coral_1.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  White Coral                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/yellow-topaz_3.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Yellow Topaz                                </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="#" className='flex'>
                                                                            <span><img alt="" src="https://imgcdn1.gempundit.com/media/catalog/category/white-zircon-230424.png?imgeng=/w_525/f_webp/cmpr_20/s_7" /></span>  Zircon                                </a>
                                                                    </li>
